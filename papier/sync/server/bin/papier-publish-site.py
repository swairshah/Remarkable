...
:root { font-size: 26px; --line-height: 1.25rem; --font-family-code: "Google Sans Code", "Courier Prime", monospace; --code-background: #f7f7f5; --code-border: #d8d5cd; --link-color: #4d4d4d; }
:root[data-theme="dark"] { --code-background: #242424; --code-border: #484848; --link-color: #a8a49c; }
