...
:root { font-size: 32px; --font-family-code: "Google Sans Code", "Courier Prime", monospace; --code-background: #f7f7f5; --code-border: #d8d5cd; --link-color: #7a5f40; }
:root[data-theme="dark"] { --code-background: #242424; --code-border: #484848; --link-color: #b5a284; }
...
.post-body { max-width: var(--body-inner-width); }
.post-body > * { margin: 0; }
.post-body > * + * { margin-top: var(--line-height); }
.post-body p { text-align: justify; text-wrap: pretty; word-break: break-word; hyphens: auto; hyphenate-limit-chars: 3; }
...
.post-body aside { clear: both; font-size: 0.875rem; line-height: 1rem; text-align: left; }
