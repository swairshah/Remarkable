...
:root { font-size: 26px; --line-height: 1.25rem; --font-family-code: "Google Sans Code", "Courier Prime", monospace; --code-background: #f7f7f5; --code-border: #d8d5cd; --link-color: #7a5f40; }
