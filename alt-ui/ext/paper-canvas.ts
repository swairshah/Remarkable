 ...
 * `-e <this file>` and PAPER_SOCK pointing at its unix tool socket.
 ...
 * messages use.
 *
 * When PAPER_SOCK is absent (a normal pi session), nothing registers —
...
const SOCK = process.env.PAPER_SOCK ?? "";
...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerTool({
    ...
    label: "paper: underline a printed phrase",
    description:
  ...
  pi.registerTool({
    name: "canvas_erase",
    label: "paper: erase one of your patches",
    description:
  ...
  pi.registerTool({
    ...
    label: "paper: insert a blank note page",
    description:
  ...
  pi.registerTool({
    ...
    label: "paper: read pages as text",
    description:
