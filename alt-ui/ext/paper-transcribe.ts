/**
 * paper-transcribe.ts — image→text context compression for Paper's pi session
 ...
 *
 * Store persists to ~/.local/share/alt-ui/transcriptions.json keyed by image hash.
...
const STORE =
  process.env.PAPER_TRANSCRIBE_STORE ??
  `${process.env.HOME || "/home/root"}/.local/share/alt-ui/transcriptions.json`;
